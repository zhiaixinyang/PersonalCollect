package com.example.mbenben.studydemo.layout.chanelview;
...
import com.example.mbenben.studydemo.layout.chanelview.util.HelperView;

public class ChanelActivity extends AppCompatActivity implements View.OnClickListener, GestureDetector.OnGestureListener {

    Context mContext = ChanelActivity.this;
    ...
    public void addTilesToContainer() {
        ...
        for (int i = 0; i < numberOfTiles; i++) {
            if (i == 0) {
                tileView = LayoutInflater.from(mContext).inflate(R.layout.layout_chanel_view, null);
