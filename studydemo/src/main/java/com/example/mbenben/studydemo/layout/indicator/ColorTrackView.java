 ...
 * @author zhy
 *
 * 原项目GitHub：https://github.com/hongyangAndroid/ColorTrackView
 * 
 */
public class ColorTrackView extends View {
	...
	public ColorTrackView(Context context, AttributeSet attrs) {
		...
		mText = ta.getString(R.styleable.ColorTrackView_colortrackview_text);
		mTextSize = ta.getDimensionPixelSize(
				R.styleable.ColorTrackView_colortrackview_text_size, mTextSize);
		mTextOriginColor = ta.getColor(
				R.styleable.ColorTrackView_colortrackview_text_origin_color, mTextOriginColor);
		mTextChangeColor = ta.getColor(
				R.styleable.ColorTrackView_colortrackview_text_change_color, mTextChangeColor);
		mProgress = ta.getFloat(R.styleable.ColorTrackView_colortrackview_progress, 0);

		mDirection = ta
				.getInt(R.styleable.ColorTrackView_colortrackview_direction, mDirection);
