package com.example.mbenben.studydemo.layout.radarscan;
...
import com.example.mbenben.studydemo.layout.ele.ZoomOutPageTransformer;
import com.example.mbenben.studydemo.layout.radarscan.bean.Info;
import com.example.mbenben.studydemo.layout.radarscan.custom.CustomViewPager;
import com.example.mbenben.studydemo.layout.radarscan.custom.RadarViewGroup;

import java.lang.reflect.Field;

public class RadarScanActivity extends Activity implements ViewPager.OnPageChangeListener, RadarViewGroup.IRadarClickListener {
    ...
    private void setViewPagerSpeed(int duration) {
        try {
            ...
            scroller = new FixedSpeedScroller(RadarScanActivity.this, new AccelerateInterpolator());
    ...
    class ViewpagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            //设置一大堆演示用的数据，麻里麻烦~~
            View view = LayoutInflater.from(RadarScanActivity.this).inflate(R.layout.radarscan_viewpager_layout, null);
            ...
            ivPortrait.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(RadarScanActivity.this, "这是 " + info.getName() + " >.<", Toast.LENGTH_SHORT).show();
                }
            });
