...
import com.example.mbenben.studydemo.utils.EvaluateUtil;
import com.example.mbenben.studydemo.utils.GeometryUtil;
...
public class ViscosityView extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mStatusBarHeight = DpUtils.getStatusBarHeight(this);
    }
