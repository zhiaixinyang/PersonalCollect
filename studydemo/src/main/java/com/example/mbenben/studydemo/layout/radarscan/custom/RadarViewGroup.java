package com.example.mbenben.studydemo.layout.radarscan.custom;
 ...
 *
 * 原项目作者博客：http://blog.csdn.net/z240336124/article/details/52075633
 */
    ...
    public void setDatas(SparseArray<Info> mDatas) {
        ...
        for (int i = 0; i < dataLength; i++) {
            ...
            if (mDatas.get(i).getSex()) {
                circleView.setPaintColor(ContextCompat.getColor(App.getInstance().getContext(),R.color.bg_color_pink));
            } else {
                circleView.setPaintColor(ContextCompat.getColor(App.getInstance().getContext(),R.color.bg_color_blue));
            }
