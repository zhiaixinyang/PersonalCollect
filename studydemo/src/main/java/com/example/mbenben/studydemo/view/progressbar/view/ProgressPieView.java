...
/**
 * 原作者项目GitHub：https://github.com/FilipPudak/ProgressPieView
 */
public class ProgressPieView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int backgroundColor = ContextCompat.getColor(context,R.color.default_background_color);
        backgroundColor = a.getColor(R.styleable.ProgressPieView_ppvBackgroundColor, backgroundColor);
        int progressColor = ContextCompat.getColor(context,R.color.default_progress_color);
        progressColor = a.getColor(R.styleable.ProgressPieView_ppvProgressColor, progressColor);
        int strokeColor = ContextCompat.getColor(context,R.color.default_stroke_color);
