 ...
 *
 * 原项目作者GitHub：https://github.com/jiangzehui/polygonsview
 */
public class LoLPolygonsview extends View {
    ...
    public LoLPolygonsview(Context context) {
        this(context, null);
    }

    public LoLPolygonsview(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LoLPolygonsview(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        one_paint.setColor(ContextCompat.getColor(context,R.color.lol_one));
        one_paint.setStyle(Paint.Style.FILL);//设置实心

        //初始化第二层多边形画笔
        two_paint = new Paint();
        two_paint.setAntiAlias(true);
        two_paint.setColor(ContextCompat.getColor(context,R.color.lol_two));
        two_paint.setStyle(Paint.Style.FILL);//设置实心

        //初始化第三层多边形画笔
        three_paint = new Paint();
        three_paint.setAntiAlias(true);
        three_paint.setColor(ContextCompat.getColor(context,R.color.lol_three));
        three_paint.setStyle(Paint.Style.FILL);//设置实心

        //初始化最内层多边形画笔
        four_paint = new Paint();
        four_paint.setAntiAlias(true);
        four_paint.setColor(ContextCompat.getColor(context,R.color.lol_four));
