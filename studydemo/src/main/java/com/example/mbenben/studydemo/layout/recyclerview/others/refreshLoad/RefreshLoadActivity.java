...
import com.example.mbenben.studydemo.layout.recyclerview.others.commonAdapterUse.basicUse.RecyclerGridSpaceDecoration;
import com.example.mbenben.studydemo.layout.recyclerview.others.widget.LoadRefreshRecyclerView;
import com.example.mbenben.studydemo.layout.recyclerview.others.widget.RefreshRecyclerView;
...
public class RefreshLoadActivity extends AppCompatActivity implements RefreshRecyclerView.OnRefreshListener, LoadRefreshRecyclerView.OnLoadMoreListener {
    ...
    class HomeAdapter extends CommonRecyclerAdapter<String> {
        ...
        public HomeAdapter(Context context, List<String> data) {
            super(context, data, R.layout.item_home_others_recyclerview);
        }
