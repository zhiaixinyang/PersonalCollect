package com.example.mbenben.studydemo.view.timer.view;
...
public class TimerHorizontalProgressView extends View {
	...
	public TimerHorizontalProgressView(Context context) {
		this(context, null);
	}

	public TimerHorizontalProgressView(Context context, @Nullable AttributeSet attrs) {
		super(context, attrs);

		TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.TimerHorizontalProgressView);
		mProgress = ta.getInteger(R.styleable.TimerHorizontalProgressView_progress, DEFAULT_PROGRESS);
		mMaxProgress = ta.getInteger(R.styleable.TimerHorizontalProgressView_maxProgress, DEFAULT_MAX_PROGRESS);
		mForegroundType = ta.getInteger(R.styleable.TimerHorizontalProgressView_foregroundProgressType, DEFAULT_FOREGROUND_TYPE);
		mBackgroundType = ta.getInteger(R.styleable.TimerHorizontalProgressView_backgroundProgressType, DEFAULT_BACKGROUND_TYPE);
		mForegroundColor = ta.getInteger(R.styleable.TimerHorizontalProgressView_foregroundProgressColor, DEFAULT_FOREGROUND_COLOR);
		mBackgroundColor = ta.getInteger(R.styleable.TimerHorizontalProgressView_backgroundProgressColor, DEFAULT_BACKGROUND_COLOR);
		ta.recycle();
