...
public class PasswordEditText extends EditText {
    ...
    private void initAttributeSet(Context context, AttributeSet attrs) {
        ...
        // 获取大小
        mDivisionLineSize = (int) array.getDimension(R.styleable.PasswordEditText_divisionLineSize, DpUtils.dp2px(mDivisionLineSize));
        mPasswordRadius = (int) array.getDimension(R.styleable.PasswordEditText_passwordRadius, DpUtils.dp2px(mPasswordRadius));
        mBgSize = (int) array.getDimension(R.styleable.PasswordEditText_passwordBgSize, DpUtils.dp2px(mBgSize));
        mBgCorner = (int) array.getDimension(R.styleable.PasswordEditText_passwordBgCorner, 0);
        // 获取颜色
        mBgColor = array.getColor(R.styleable.PasswordEditText_passwordBgColor, mBgColor);
