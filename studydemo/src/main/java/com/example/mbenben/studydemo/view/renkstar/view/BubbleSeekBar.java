...
public class BubbleSeekBar extends View {
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSectionTextSize = a.getDimensionPixelSize(R.styleable.BubbleSeekBar_bsb_section_text_size, DpUtils.sp2px(14));
        ...
        mThumbTextSize = a.getDimensionPixelSize(R.styleable.BubbleSeekBar_bsb_thumb_text_size, DpUtils.sp2px(14));
        ...
        mBubbleTextSize = a.getDimensionPixelSize(R.styleable.BubbleSeekBar_bsb_bubble_text_size, DpUtils.sp2px(14));
    ...
    private void initConfigByPriority() {
        ...
        if (mSecondTrackSize < mTrackSize) {
            mSecondTrackSize = mTrackSize + DpUtils.sp2px(2);
        }
        if (mThumbRadius <= mSecondTrackSize) {
            mThumbRadius = mSecondTrackSize + DpUtils.sp2px(2);
        }
    ...
    private void calculateRadiusOfBubble() {
        ...
        mBubbleRadius = DpUtils.sp2px(14); // default 14dp
    ...
    private void locatePositionOnScreen() {
        ...
        mBubbleCenterRawSolidY -= DpUtils.sp2px(24);
        if (BubbleUtils.isMIUI()) {
            mBubbleCenterRawSolidY += DpUtils.sp2px(4);
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isShowTextBelowSectionMark || isShowSectionMark) {
            float r = (mThumbRadiusOnDragging - DpUtils.sp2px(2)) / 2f;
    ...
    private boolean isThumbTouched(MotionEvent event) {
        ...
        return (event.getX() - x) * (event.getX() - x) + (event.getY() - y) * (event.getY() - y)
                <= (mLeft + DpUtils.sp2px(8)) * (mLeft + DpUtils.sp2px(8));
    }
    ...
    private class BubbleView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            mBubblePath.quadTo(
                    x1 - DpUtils.sp2px(2), y1 - DpUtils.sp2px(2),
                    x1, y1
            );
            ...
            mBubblePath.quadTo(
                    x2 + DpUtils.sp2px(2), y1 - DpUtils.sp2px(2),
                    x0, y0
            );
            mBubblePath.close();
