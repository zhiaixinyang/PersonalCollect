package com.example.mbenben.studydemo.layout.newbottomnav.view;
 ...
 *
 * 原作者项目博客：https://github.com/armcha/LuseenBottomNavigation
 */
public class BottomNavigationView extends RelativeLayout {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        for (int i = 0; i < bottomNavigationItems.size(); i++) {
            ...
            final View view = inflater.inflate(R.layout.view_bottom_navigation, this, false);
