package com.example.mbenben.studydemo.layout.recyclerview.layoutmanager.group.fragment;
...
import com.example.mbenben.studydemo.layout.recyclerview.layoutmanager.group.bean.SlideBean;
import com.example.mbenben.studydemo.layout.recyclerview.layoutmanager.group.layoutmanagergroup.slide.ItemConfig;
import com.example.mbenben.studydemo.layout.recyclerview.layoutmanager.group.layoutmanagergroup.slide.ItemTouchHelperCallback;
import com.example.mbenben.studydemo.layout.recyclerview.layoutmanager.group.layoutmanagergroup.slide.OnSlideListener;
import com.example.mbenben.studydemo.layout.recyclerview.layoutmanager.group.layoutmanagergroup.slide.SlideLayoutManager;
import com.example.mbenben.studydemo.layout.recyclerview.layoutmanager.group.widget.SmileView;
...
public class SlideFragment extends Fragment {
    ...
    private void initView(View rootView) {
        ...
        mSmileView = (SmileView) rootView.findViewById(R.id.smile_view);
    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(App.getAllContext()).inflate(R.layout.item_slide, parent, false);
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public ViewHolder(View itemView) {
                ...
                userIcon = (ImageView) itemView.findViewById(R.id.img_user);
                tvTitle = (TextView) itemView.findViewById(R.id.tv_title);
                userSay = (TextView) itemView.findViewById(R.id.tv_user_say);
            }
        }
    }
}
