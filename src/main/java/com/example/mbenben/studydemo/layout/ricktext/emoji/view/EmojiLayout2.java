package com.example.mbenben.studydemo.layout.ricktext.emoji.view;
...
import com.example.mbenben.studydemo.layout.ricktext.emoji.adapter.ExpressionPagerAdapter;
import com.example.mbenben.studydemo.layout.ricktext.emoji.adapter.SmileImageExpressionAdapter;
...
public class EmojiLayout2 extends LinearLayout {
    ...
    private void init(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.view_layout_emoji_container, this, true);
        if (isInEditMode())
            return;
    ...
    private void initViews() {
        int size = DpUtils.dp2px(5);
        int marginSize = DpUtils.dp2px( 5);
    ...
    private View getGridChildView(int i) {
        View view = View.inflate(getContext(), R.layout.view_expression_gridview, null);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                try {
                    if (filename != "delete_expression") { // 不是删除键，显示表情
                        /**插入表情*/
                        SmileUtils.insertIcon(editTextEmoji, 2000, DpUtils.dp2px(20), filename);
