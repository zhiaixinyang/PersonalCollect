...
public class EleViewPagerActivity extends AppCompatActivity {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_ele_viewpager);

    mRecyclerView = (RecyclerView) findViewById(R.id.recyclerView);
    mViewPager = (ViewPager) findViewById(R.id.vp_one);
  ...
  private class Adapter extends PagerAdapter {
    public Adapter() {
      views = new ArrayList<>();
      views.add(View.inflate(EleViewPagerActivity.this, R.layout.item_ele_img, null));
      views.get(0).findViewById(R.id.btn_buy).setOnClickListener(new View.OnClickListener() {
        @Override public void onClick(View v) {
          Toast.makeText(EleViewPagerActivity.this, "buy", Toast.LENGTH_SHORT).show();
        }
      });
      views.add(View.inflate(EleViewPagerActivity.this, R.layout.item_ele_img, null));
