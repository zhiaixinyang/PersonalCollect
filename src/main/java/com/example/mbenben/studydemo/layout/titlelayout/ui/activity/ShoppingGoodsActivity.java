package com.example.mbenben.studydemo.layout.titlelayout.ui.activity;
...
import com.example.mbenben.studydemo.layout.titlelayout.adapter.BaseAdapter;
import com.example.mbenben.studydemo.layout.titlelayout.adapter.BaseViewHolder;
import com.example.mbenben.studydemo.layout.titlelayout.entity.ShopGoodsBean;
import com.example.mbenben.studydemo.layout.titlelayout.entity.StoreGoodsBean;
import com.example.mbenben.studydemo.layout.titlelayout.imp.AppBarStateChangeListener;
import com.example.mbenben.studydemo.layout.titlelayout.ui.BaseActivity;
import com.example.mbenben.studydemo.layout.titlelayout.ui.dialog.DiscountCouponDialog;
import com.example.mbenben.studydemo.layout.titlelayout.ui.dialog.ShoppingCartDialog;
import com.example.mbenben.studydemo.layout.titlelayout.utils.ShoppingCartHistoryManager;
import com.example.mbenben.studydemo.layout.titlelayout.utils.ToastUtil;
import com.example.mbenben.studydemo.layout.titlelayout.utils.Util;
...
public class ShoppingGoodsActivity extends BaseActivity implements BaseAdapter.BaseAdapterListener<ShopGoodsBean> {
    ...
    public static void start(Context context, String title) {
        Intent intent = new Intent(context, ShoppingGoodsActivity.class);
    ...
    public void initHeight() {
        ...
        layoutParams.height = DensityUtil.dip2px(App.getAllContext(), 200) + (int) getStatusBarHeight(this);
