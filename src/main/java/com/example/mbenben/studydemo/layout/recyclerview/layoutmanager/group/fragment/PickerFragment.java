...
import com.example.mbenben.studydemo.layout.recyclerview.layoutmanager.group.layoutmanagergroup.picker.PickerLayoutManager;
...
public class PickerFragment extends Fragment  {
    ...
    private void initView(View rootView) {
        mRecyclerView1 = (RecyclerView) rootView.findViewById(R.id.recycler1);
        mRecyclerView2 = (RecyclerView) rootView.findViewById(R.id.recycler2);
        mTvHour = (TextView) rootView.findViewById(R.id.tv_hour);
        mTvMinute = (TextView) rootView.findViewById(R.id.tv_minute);
    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder>{
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(App.getAllContext()).inflate(R.layout.item_picker,parent,false);
