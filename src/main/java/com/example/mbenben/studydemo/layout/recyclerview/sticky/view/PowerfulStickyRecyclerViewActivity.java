...
import com.example.mbenben.studydemo.layout.recyclerview.sticky.util.CityUtil;
import com.example.mbenben.studydemo.layout.recyclerview.sticky.util.DensityUtil;
import com.example.mbenben.studydemo.layout.recyclerview.sticky.util.PowerfulStickyDecoration;
import com.example.mbenben.studydemo.layout.recyclerview.sticky.util.listener.PowerGroupListener;
    ...
    private void initView() {
        ...
        mAdapter = new RecyclerView.Adapter() {
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_sticky_recycler_view, parent, false);
