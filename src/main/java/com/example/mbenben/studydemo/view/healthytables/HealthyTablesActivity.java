...
/**
 * Created by MDove on 2017/1/2.
 * 折线图效果
 */

public class HealthyTablesActivity extends BaseActivity {
    private static final String ACTION_EXTRA = "action_extra";

    public static void start(Context context, String title) {
        Intent intent = new Intent(context, HealthyTablesActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_healthytables);
    }
