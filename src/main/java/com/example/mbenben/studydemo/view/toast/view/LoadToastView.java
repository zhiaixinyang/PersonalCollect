package com.example.mbenben.studydemo.view.toast.view;
...
public class LoadToastView extends View {
    ...
    public LoadToastView(Context context) {
        ...
        successPaint.setColor(ContextCompat.getColor(App.getInstance().getContext(),
                R.color.toast_color_success));
        errorPaint.setColor(ContextCompat.getColor(App.getInstance().getContext(),
        ...
        completeicon = getResources().getDrawable(R.drawable.ic_toast_navigation_check);
        completeicon.setBounds(iconBounds);
        failedicon = getResources().getDrawable(R.drawable.ic_toast_error);
