package com.example.mbenben.studydemo.view.progressbar.view;
 ...
 * </br>
 *
 * 原作者项目GitHub：https://github.com/LineChen/FlickerProgressBar
 */
public class FlikerProgressBar extends View implements Runnable{
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        try {
            textSize = (int) ta.getDimension(R.styleable.FlikerProgressBar_progressbar_textSize, 12);
            loadingColor = ta.getColor(R.styleable.FlikerProgressBar_progressbar_loadingColor, Color.parseColor("#40c4ff"));
            stopColor = ta.getColor(R.styleable.FlikerProgressBar_progressbar_stopColor, Color.parseColor("#ff9800"));
            radius = (int) ta.getDimension(R.styleable.FlikerProgressBar_progressbar_radius, 0);
            borderWidth = (int) ta.getDimension(R.styleable.FlikerProgressBar_progressbar_borderWidth, 1);
        } finally {
            ta.recycle();
        }
    }
