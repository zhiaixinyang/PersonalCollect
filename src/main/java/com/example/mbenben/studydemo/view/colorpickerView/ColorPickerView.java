...
public class ColorPickerView extends FrameLayout {
    ...
    private void getAttrs(AttributeSet attrs) {
        ...
        try {
            if (a.hasValue(R.styleable.colorpicker_cp_src))
                imageViewDrawable = a.getDrawable(R.styleable.colorpicker_cp_src);
            if (a.hasValue(R.styleable.colorpicker_cp_selector))
                selectorDrawable = a.getDrawable(R.styleable.colorpicker_cp_selector);
        } finally {
            a.recycle();
        }
    }
    ...
    private void onCreate() {
        ...
        LayoutParams wheelParams = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
