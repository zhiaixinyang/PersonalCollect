...
public class CountDownView extends View {
    ...
    public CountDownView(Context context, AttributeSet attrs) {
        ...
        backgroundColor = ta.getColor(R.styleable.CountDownView_cdv_background_color, BACKGROUND_COLOR);
        borderWidth = ta.getDimension(R.styleable.CountDownView_cdv_border_width, BORDER_WIDTH);
        borderColor = ta.getColor(R.styleable.CountDownView_cdv_border_color, BORDER_COLOR);
        text = ta.getString(R.styleable.CountDownView_cdv_text);
        if (text == null) {
            text = TEXT;
        }
        textSize = ta.getDimension(R.styleable.CountDownView_cdv_text_size, TEXT_SIZE);
        textColor = ta.getColor(R.styleable.CountDownView_cdv_text_color, TEXT_COLOR);
        ta.recycle();
        init();
    }
