...
import com.example.mbenben.studydemo.view.jbox.mobike.Mobike;
 ...
 */
public class JBoxDemoActivity extends BaseActivity {
    ...
    public static void start(Context context, String title) {
        Intent intent = new Intent(context, JBoxDemoActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jbox);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.editParams) {
            ...
            intent.putExtra(ACTION_EXTRA, mTitle);
            ...
            MobikeDemoActivity.start(this, mTitle);
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.jbox_menu, menu);
