...
import com.example.mbenben.studydemo.layout.ricktext.span.ClickAtUserSpan;
import com.example.mbenben.studydemo.layout.ricktext.span.LinkSpan;
...
public class TextCommonUtils {
    ...
    public static Spannable getUrlEmojiText(Context context, String text, TextView textView,
                                            int color, boolean needNum, SpanAtUserCallBack spanAtUserCallBack, SpanUrlCallBack spanUrlCallBack) {
        if (!TextUtils.isEmpty(text)) {
            return getUrlSmileText(context, text, null, textView, color,
                    needNum, spanAtUserCallBack, spanUrlCallBack);
        } else {
            return new SpannableString(" ");
        }
    }
     ...
     * @param spanUrlCallBack    链接点击的返回
     */
    public static void setUrlSmileText(Context context, String string, List<UserModel> listUser,
                                       TextView textView, int color, boolean needNum, SpanAtUserCallBack spanAtUserCallBack, SpanUrlCallBack spanUrlCallBack) {
        Spannable spannable = getUrlSmileText(context, string, listUser, textView, color,
                needNum, spanAtUserCallBack, spanUrlCallBack);
     ...
     * @return 返回显示的spananle
     */
    public static Spannable getUrlSmileText(Context context, String string,
                                            List<UserModel> listUser, TextView textView,
                                            int color, boolean needNum,
        ...
        if (!TextUtils.isEmpty(string)) {
            ...
            Spannable spannable = getAtText(context, listUser, string, textView,
                    true, color, needNum, spanAtUserCallBack);
            textView.setText(spannable);
     ...
     * @return 返回显示的spananle
     */
    private static Spannable resolveUrlLogic(Context context, TextView textView,
                                             Spannable spannable, int color, boolean needNum,
                                             SpanUrlCallBack spanUrlCallBack) {
